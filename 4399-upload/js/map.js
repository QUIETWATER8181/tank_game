(function () {
  ...
  var Map = {
    ...
    dryWaterCell: function (worldMap, obstacle) {
      if (!worldMap || !obstacle || obstacle.kind !== "W") { return false; }
      worldMap.driedGround = worldMap.driedGround || [];
      if (!worldMap.driedGround.some(function (cell) { return cell.row === obstacle.row && cell.column === obstacle.column; })) {
        worldMap.driedGround.push({
          x: obstacle.x,
          y: obstacle.y,
      ...
      this.removeObstacle(worldMap, obstacle);
      return true;
    },
