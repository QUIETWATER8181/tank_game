(function () {
  ...
  AudioSystem.prototype.initializeSoundEffects = function () {
    ...
    Object.keys(configured).forEach(function (name) {
      ...
      sound.volume = {
        ...
        explode: 0.68, pickup: 0.62, pageTurn: 0.3, boostPickup: 0.62, hit: 0.56, victory: 0.68, burn: 0.22
      }[name] || 0.45;
  ...
  AudioSystem.prototype.playLoaded = function (name, onFailure) {
    var self = this;
  ...
  AudioSystem.prototype.play = function (name) {
    var self = this;
    this.initializeSoundEffects();
    if (this.playLoaded(name)) { return; }
